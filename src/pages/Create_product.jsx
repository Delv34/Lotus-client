                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex flex-col gap-[30px] ml-[20px] mb-[20px]">
                                <div className="flex items-center gap-[10px]">
                                    <div className={selected == 1 ? "product_image border-[#1D27A4]" : "product_image !border-[#8D96FF]"} onClick={()=> setSelected(1)}><img className="w-[220px] h-[152px] object-cover rounded-[12px]" src={img1} alt="" /></div>
                        ...
                        <div className="flex flex-col items-end">
                          <div className="flex flex-col items-center mb-[40px] ">
                            ...
                            <div className="flex flex-col px-[12px]">
                                <div className="font-I-Reg text-[16px] w-[196px] break-words mb-[10px]">{name}</div>
                                <div className="flex flex-col">
